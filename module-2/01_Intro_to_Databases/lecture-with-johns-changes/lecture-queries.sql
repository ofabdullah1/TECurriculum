...
SELECT * FROM city WHERE area < 25;
...
SELECT * FROM state WHERE (census_region IS NOT NULL) AND (state_nickname IS NOT NULL); 
...
SELECT * FROM CITY WHERE (area < 25) AND (population > 100000)
...
SELECT (area *1000000)  area_in_square_meters ,* FROM park;




-- All values vs. distinct valuee
...
SELECT * FROM park WHERE date_established < '1950-01-01'
