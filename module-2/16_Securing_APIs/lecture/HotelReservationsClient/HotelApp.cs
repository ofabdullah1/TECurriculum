...
namespace HotelReservationsClient
{
    public class HotelApp
    {
        ...
        private readonly AuthenticationApiService authApiService;
        ...
        public HotelApp(string apiURL)
        {
            ...
            this.authApiService = new AuthenticationApiService(apiURL);
        }
        ...
        public void Run()
        {
            while (true)
            {
                console.PrintMainMenu(authApiService.LoggedIn);
        ...
        private void Login()
        {
            ...
            try
            {
                bool login = authApiService.Login(username, password);
                if (login)
                {
