...
namespace DadabaseApp
{
    ...
    public class UserInterface
    {
        ...
        public void AddJoke()
        {
            ...
            Console.WriteLine("What's the joke's setup?");
            string setup = Console.ReadLine();

            Console.WriteLine("What's the joke's punchline?");
        ...
        public void ListAllDadJokes()
        {
            ...
            // Loop over the list of dad jokes and print each one to the screen
