...
('What dod you call this: ["hip", "hip"]', 'A hip, hip array', 6),
('Why dod Communists hate OOP?', 'All of the classes...',1),
...
SELECT j.joke_id AS id,j.setup,j.punchline,h.name As humor_level FROM Joke j INNER JOIN HumorLevel h ON h.level_id = j.humor_level_id ORDER BY h.level_id ASC, j.setup ASC, j.punchline ASC
